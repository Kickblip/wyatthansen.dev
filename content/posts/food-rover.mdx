---
title: Autonomous Food Delivery Rover
...
cover: "/food-rover/cover.webp"
tags: ["Python", "OpenCV", "Raspberry Pi", "TFLite"]
...
<ImageWithCaption src={"/food-rover/rover.jpeg"} alt={"Image of the food delivery rover"} />
...
<div className="flex">
  <div className="w-1/2">
    <ImageWithCaption
      src={"/food-rover/raspberrypi.jpg"}
      alt={"Image of Raspberry Pi"}
      caption={"Raspberry Pi (left) and Pixhawk (right)"}
    />
  </div>
  <div className="w-1/2">
    <ImageWithCaption src={"/food-rover/pixhawk.jpeg"} alt={"Image of Pixhawk controller"} />
  </div>
</div>
...
<ImageWithCaption src={"/food-rover/mission-planner.jpeg"} alt={"Mission planning software"} />
...
<div className="flex">
  <div className="w-1/2">
    <ImageWithCaption src={"/food-rover/undetected.png"} alt={"Undetected example"} />
  </div>
  <div className="w-1/2">
    <ImageWithCaption src={"/food-rover/detected.png"} alt={"Detected example"} />
  </div>
</div>
