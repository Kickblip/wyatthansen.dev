...
cover: "/tos-chat/cover.webp"
tags: ["TypeScript", "NextJS", "TailwindCSS", "Pinecone", "LangChain", "MongoDB"]
live: "https://www.tos.chat/"
---

**2026 DISCLAIMER: This project was built on an early version of GPT-3 in 2020, before ChatGPT included all these features out of the box.**
...
<ImageWithCaption src={"/tos-chat/hero.png"} alt={"The homepage of TOS Chat"} caption={"TOS Chat homepage"} />

# TOS Chat Versus ChatGPT

TOS Chat runs on the same language model as ChatGPT but it has some added functionality that make it much better suited for handling legal documents.
...
<ImageWithCaption
  src={"/tos-chat/semantic-search.png"}
  alt={"Chart illustrating semantic search flow"}
...
<ImageWithCaption
  src={"/tos-chat/index.png"}
  alt={"Vector database analytics"}
  caption={"Chunked embeddings being stored in Pinecone"}
/>
