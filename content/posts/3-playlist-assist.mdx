...
Many people curate their playlists, but fewer think about the transitions between songs.
...
The Spotify API lacks support for webhooks or long-polling so I had to set up a local timer to track this.
