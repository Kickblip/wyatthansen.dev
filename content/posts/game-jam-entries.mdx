...
cover: "/game-jam-entries/cover.webp"
tags: ["Unity", "Godot", "APIs"]
...
<ImageWithCaption
  src={"/game-jam-entries/npcinteraction.png"}
  alt={"Chart illustrating the NPC interaction flow"}
  caption={"NPC interaction flow"}
/>
