...
Regardless of whether you've used food delivery services like Doordash and Uber Eats, their convenience is undeniable. 
...
Jackson (an electrical engineering major) was mostly interested in the hardware side of the rover. 
I focused on the control systems that piloted the rover. 
Specifically, I worked on a human detection system that would allow the rover to avoid obstacles and people.
