...
My friend (an electrical engineering major) was mostly interested in the hardware side of the rover. So my main contribution to the project was a human detection system that would allow the robot to avoid obstacles and people. This was my first time working with AI, and I learned a lot about the process of training and deploying models.
