...
cover: "/playlist-assist/cover.webp"
...
<ImageWithCaption
  src={"/playlist-assist/playlist_assist.png"}
  alt={"The Playlist Assist UI"}
  caption={"The Playlist Assist UI"}
/>
...
<ImageWithCaption
  src={"/playlist-assist/playing_music.png"}
  alt={"Screenshot of the progress bar from Spotify"}
  caption={"Playing music on Spotify"}
/>
...
<ImageWithCaption
  src={"/playlist-assist/shufflingvector.png"}
  alt={"Code screenshot of remapping function"}
  caption={"Feature vector remapped from API data"}
/>
...
<ImageWithCaption src={"/playlist-assist/segmentsnip.png"} alt={"JSON screenshot of Spotify API output"} />
