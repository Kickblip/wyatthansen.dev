...
export default function Home() {
    return (
        <div className="prose dark:prose-invert w-full max-w-none">
            <HomeIntro
                title="Hi, I'm Wyatt"
                description="I like machine learning, robotics, and web development. I'm an undergraduate student working in the Human-Aware Planning and AI lab at CSU. Here are some of the projects I've worked on..."
            />
